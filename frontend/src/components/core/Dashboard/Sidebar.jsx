...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {openSideMenu && (
        <div className="flex h-[calc(100vh-3.5rem)] min-w-[220px] flex-col border-r-[1px] border-r-white-700 bg-white-800 py-10 ">
          ...
          <div className="mx-auto mt-6 mb-6 h-[1px] w-10/12 bg-white-700" />
