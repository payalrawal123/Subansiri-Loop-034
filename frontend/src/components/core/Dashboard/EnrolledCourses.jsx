...
export default function EnrolledCourses() {
  ...
  return (
    <>
      <div className="mt-14 text-richblack-500 text-4xl text-richblack-5 font-boogaloo text-center sm:text-left">
        Enrolled Courses
      </div>
      {
        <div className="my-8 text-richblack-5">
          ...
          {enrolledCourses?.map((course, i, arr) => (
            ...
            >
              <div
                className="flex sm:w-[45%] text-richblack-500 cursor-pointer items-center gap-4 px-5 py-3"
                onClick={() => {
                  navigate(
              ...
              {/* duration -  progress */}
              <div className="sm:hidden text-richblack-500">
              ...
              {/* duration -  progress */}
              <div className="hidden w-1/5 sm:flex px-2 py-3  text-richblack-500">
                {course?.totalDuration}
              </div>
              <div className="hidden sm:flex w-1/5 flex-col gap-2 px-2 py-3 text-richblack-500">
                <p>Progress: {course.progressPercentage || 0}%</p>
                <ProgressBar
                  completed={course.progressPercentage || 0}
                  height="8px"
