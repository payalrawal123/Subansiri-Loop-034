        ...
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              ...
              <h1 className="text-richblack-800 font-semibold text-[16px]">
                Company
              </h1>
              <div className="flex flex-col gap-2">
                {["About", "Careers", "Affiliates"].map((ele, i) => {
                  return (
                    <div
                      key={i}
                      className="text-[14px] cursor-pointer hover:text-richblack-800 transition-all duration-200"
                    >
            ...
            <div className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
              ...
              <h1 className="text-richblack-800 font-semibold text-[16px] mt-7">
                Support
              </h1>
              <div className="text-[14px] cursor-pointer hover:text-richblack-800 transition-all duration-200 mt-2">
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
              ...
              return (
                <div
                  ...
                  className={` ${
                   ...
                   px-3 cursor-pointer hover:text-richblack-800 transition-all duration-200`}
                >
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link
                to="https://github.com/payalrawal123/Subansiri-Loop-034"
                target="__blank"
                className="text-richblack-800 hover:underline mr-1"
              >
                Subansiri-Loop-034
              </Link>
            </div>
            <span> © 2023 LearnLang</span>
          </div>
