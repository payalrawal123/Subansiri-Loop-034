...
const Home = () => {
  ...
  return (
    <React.Fragment>
      ...
      <div className=" ">
        {/*Section1  */}
        <div className="relative h-[450px] md:h-[550px] justify-center mx-auto mt-14 flex flex-col w-11/12 max-w-maxContent items-center text-white ">
          <Link to={"/signup"}>
            <div
        ...
        {/*Section 3 */}
        <div className="p-10   flex-col items-center justify-between  first-letter bg-white text-richblack-800">
          <InstructorSection />
